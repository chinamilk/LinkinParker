...
0
|| checktplrefresh('./template/tqun/common/header.htm', './template/tqun/common/header_common.htm', 1380681163, '14', './data/template/13_14_common_header_forum_forumdisplay.tpl.php', './template/tqun', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/tqun/common/header.htm', './template/tqun/common/pubsearchform.htm', 1380681163, '14', './data/template/13_14_common_header_forum_forumdisplay.tpl.php', './template/tqun', 'common/header_forum_forumdisplay')
;?>
