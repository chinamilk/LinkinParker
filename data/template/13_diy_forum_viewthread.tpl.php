...
0
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/common/header.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/forum/viewthread_node.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/forum/viewthread_fastpost.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/common/footer.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/common/header_common.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/common/pubsearchform.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/tqun/forum/viewthread_node_body.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/default/common/seditor.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/tqun//forum/viewthread.htm', './template/default/common/seccheck.htm', 1380679899, 'diy', './data/template/13_diy_forum_viewthread.tpl.php', 'data/diy/./template/tqun/', 'forum/viewthread')
;
block_get('788,787');?>
...
<style id="diy_style" type="text/css">#portal_block_787 {  border-top:#006600 7px solid !important;border-right:#cc9900 0px solid !important;border-bottom:#cc9900 0px solid !important;border-left:#cc9900 0px solid !important;}#portal_block_788 {  border-top:#006600 7px solid !important;border-left:#999999 1px dotted !important;}</style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"></div><!--[/diy]-->
<div id="view_top">
        <div class="v_t_r"> <!--[diy=diy11]--><div id="diy11" class="area"><div id="frameody558" class="frame move-span cl frame-1"><div id="frameody558_left" class="column frame-1-c"><div id="frameody558_left_temp" class="move-span temp"></div><?php block_display('788');?></div></div></div><!--[/diy]--></div>
        <div class="v_t_l"> <!--[diy=diy12]--><div id="diy12" class="area"><div id="frameTf66BI" class="frame move-span cl frame-1"><div id="frameTf66BI_left" class="column frame-1-c"><div id="frameTf66BI_left_temp" class="move-span temp"></div><?php block_display('787');?></div></div></div><!--[/diy]--></div>
</div>
...
<table id="pid<?php echo $post['pid'];?>" summary="pid<?php echo $post['pid'];?>" cellspacing="0" cellpadding="0">
    <tr>
        <td class="pls" rowspan="2">
            ...
            <div class="p_pop blk bui" id="userinfo<?php echo $post['pid'];?>" style="display: none; <?php if($_G['setting']['authoronleft']) { ?>margin-top: -11px;<?php } ?>">
                ...
                <div class="i y">
                    ...
                    <ul class="xl xln o cl">
                        ...
                        <li><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $post['authorid'];?>&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $post['pid'];?>&amp;tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息" class="xi2">发消息</a></li>
                    </ul>
                    <?php } ?>
                </div>
            </div>
            ...
            <?php if($post['custominfo']['left']) { ?><dl class="pil cl"><?php echo $post['custominfo']['left'];?></dl><?php } ?>
            <?php if($post['medals']) { ?>
            <p class="md_ctrl">
...
<?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { ?><?php $nxtpage = $page + 1;?><table cellspacing="0" cellpadding="0" class="ad">
<tr>
<td class="pls"></td>
<td class="plc">
