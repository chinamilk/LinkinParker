...
0
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/common/header.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/forum/forumdisplay_list.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/forum/forumdisplay_sort.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/common/footer.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/common/header_common.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/common/pubsearchform.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/forum/search_sortoption.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/tqun//forum/forumdisplay.htm', './template/tqun/forum/search_sortoption.htm', 1380679966, 'diy', './data/template/13_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/tqun/', 'forum/forumdisplay')
;?>
    ...
    <div id="ct" class="wp cl">
        <div class="mn">
            ...
            <div class="mtm mbm cl">
                <?php if(!$_GET['archiveid']) { ?><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" id="newspecial" title="发新帖">发新帖</a><?php } ?>
                <?php if(!$subforumonly) { ?>今日: <span class="xi1"><?php echo $_G['forum']['todayposts'];?></span><span class="pipe">|</span>主题: <span class="xi1"><?php echo $_G['forum']['threads'];?></span><span class="pipe">|</span><?php } ?>
...
<?php if($_G['setting']['threadmaxpages'] > 1 && $page && !$subforumonly && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { ?><?php $nxtpage = $page + 1;?><div id="pgbtn" class="pgbtn"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=<?php echo $filter;?>&amp;orderby=<?php echo $_GET['orderby'];?><?php echo $forumdisplayadd['page'];?>&amp;<?php echo $multipage_archive;?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true"><?php echo '下一页 &raquo;'; ?></a></div>
<?php } ?>
