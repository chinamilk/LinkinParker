...
0
|| checktplrefresh('./template/tqun/common/header.htm', './template/tqun/common/header_common.htm', 1380680000, '14', './data/template/13_14_common_header_member_register.tpl.php', './template/tqun', 'common/header_member_register')
|| checktplrefresh('./template/tqun/common/header.htm', './template/tqun/common/pubsearchform.htm', 1380680000, '14', './data/template/13_14_common_header_member_register.tpl.php', './template/tqun', 'common/header_member_register')
;?>
